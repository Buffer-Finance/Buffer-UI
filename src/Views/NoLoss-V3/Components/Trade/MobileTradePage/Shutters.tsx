import { activeTournamentIdAtom } from '@Views/NoLoss-V3/atoms';
...
import { ActiveTrades } from '../BuyTradeSection/ActiveTrades';
import { EditTradeConfigShutter } from './EditTradeConfigShutter';
import { MarketSwitcherShutter } from './MarketSwitcherShutter';
  ...
  return (
    ...
    >
      <div className="w-full a600:w-[500px] mx-auto mb-3 mt-2">
        {shutterState.open == 'BO' && <EditTradeConfigShutter />}
        {shutterState.open == 'MarketSelector' && <MarketSwitcherShutter />}
      ...
      <div className="w-full b1200:sticky b1200:top-[0px] b1200:z-50 bg-[#282b39] flex justify-evenly text-f14 rounded-t-[8px] py-[8px]  mt-3">
        ...
        {activeTournamentId && (
          <button
            ...
            onClick={() => {
              closeShutter();
              navigate(`/history/${activeTournamentId}`);
            }}
          >
            <ExpandSVG />
          </button>
