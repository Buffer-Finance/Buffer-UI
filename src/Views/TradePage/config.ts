...
export const appConfig = {
  ...
  '42161': {
    graph: {
      MAIN: 'https://subgraph.satsuma-prod.com/e66b06ce96d2/bufferfinance/v2.5-arbitrum-mainnet/version/v2.9.3-ab-profile-user-cumulative-optionwise-new-schema/api',
    },
