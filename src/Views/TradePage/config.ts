...
export const appConfig = {
  '421614': isSandbox
    ? {
        graph: {
          MAIN: `https://subgraph.satsuma-prod.com/273f467f1a10/bufferfinance/arbitrum-sandbox-testnet/api`,
          LEADERBOARD: '',
          REWARDS: '',
          LP: '',
        },
    ...
    : {
        graph: {
          ...
          LP: `https://subgraph.satsuma-prod.com/273f467f1a10/bufferfinance/jackpot/version/v3.0.19-pool-tracking-update-locknft-contracts/api`,
        },
