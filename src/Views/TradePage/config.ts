...
import { ContractsConfig } from '@ConfigContract';
...
export const appConfig = {
  '421614': {
    ...
    signer_manager: ContractsConfig['421614'].signer_manager,
    booster: '0xbE96E1260090Ec873ed9F246f548fcF67a7da148',
    config_setter: '0xf5FE716462112a3352926F63d92b51293ac5d006',
    v2_router: ContractsConfig['421614'].ud.router,
    jackpot: ContractsConfig['421614'].jackpot,
    above_below_router: ContractsConfig['421614'].ab.router,
    product_id: {
      UP_DOWN: {
        id: 2,
        environment: '421614',
      ...
      AB: {
        ...
        name: 'AB',
        product_id: 'xyz',
        router: ContractsConfig['421614'].ab.router,
      },
    },
    poolsInfo: ContractsConfig['421614'].poolsInfo,
    EarnConfig: {
  ...
  '42161': {
    graph: {
      ...
      LEADERBOARD: `https://subgraph.satsuma-prod.com/e66b06ce96d2/bufferfinance/mainnet-dummy/version/v0.0.10-leaderboard-page/api`,
      DASHBOARD:
    ...
    signer_manager: ContractsConfig[42161].signer_manager,
...
export const OldVersionTradesRedirect = {
  UD: 'https://past-ud-trades.buffer.finance/',
  AB: 'https://past-ab-trades.buffer.finance',
};
