...
export const appConfig = {
  '421613': isSandbox
    ...
    : {
        graph: {
          MAIN: 'https://subgraph.satsuma-prod.com/e66b06ce96d2/bufferfinance/arbitrum-testnet/version/v2.5.9-leaderboard-win-trades-2/api',
        },
  ...
  '42161': {
    graph: {
      MAIN: 'https://subgraph.satsuma-prod.com/e66b06ce96d2/bufferfinance/v2.5-arbitrum-mainnet/version/v2.5.19-add-router-2/api',
    },
