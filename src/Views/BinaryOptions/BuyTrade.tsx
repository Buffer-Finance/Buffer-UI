...
import { DownIconWhite } from '@SVG/Elements/DownIcon';
import { UpIconWhite } from '@SVG/Elements/UpIcon';
...
const BuyTrade: React.FC<any> = ({}) => {
  ...
  const [balance, allowanceWei, maxTrade, _] = activeAssetState;
  ...
  const isAssetActive = !activeAsset.is_paused;
