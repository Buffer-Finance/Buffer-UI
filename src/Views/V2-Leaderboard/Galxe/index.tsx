...
import { ContestFilterDD } from './GalxeWeekDD';
...
export const galxTaskLink =
  'https://app.galxe.com/quest/XZeZw9Mauqx5SQyn6uGAbs/GCcBktzv13';
...
export const Galxe = () => {
  ...
  //   });
  const week = 5;
  const nextTimeStamp = 1679328000000;
  const {
    data,
    totalTournamentData,
    loserUserRank,
  ...
  const { offset, setOffset } = useGalxeWeekOffset();
